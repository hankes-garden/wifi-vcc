...
extern void vcc(uint32_t nStaNum, uint32_t nUdpMaxPktCount, bool rts,
		bool hidden);
extern void baseline(uint32_t nStaNum, uint32_t nUdpMaxPktCount, bool rts,
		bool hidden);
...
int main(int argc, char *argv[])
{
	...
	uint32_t nSta = 20;
	uint32_t nMaxPktCount = 250;

	std::cout << "===== baseline_no_rts ==============" << std::endl;
	baseline(nSta, nMaxPktCount, false, bHasHiddenTerminal);
	std::cout << std::endl;

	std::cout << "===== baseline_rts =================" << std::endl;
	baseline(nSta, nMaxPktCount, true, bHasHiddenTerminal);
	std::cout << std::endl;

	std::cout << "===== vcc ==========================" << std::endl;
	vcc(nSta, nMaxPktCount, bEnableRTS, bHasHiddenTerminal);
	std::cout << std::endl;
...
void vcc(uint32_t nStaNum, uint32_t nUdpMaxPktCount, bool rts, bool hidden)
{
...
void baseline(uint32_t nStaNum, uint32_t nUdpMaxPktCount, bool rts, bool hidden)
{
