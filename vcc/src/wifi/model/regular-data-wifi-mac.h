 ...
 */
#ifndef REGULAR_DATA_WIFI_MAC_H
#define REGULAR_DATA_WIFI_MAC_H
 ...
 *
 */
class RegularDataWifiMac : public WifiMac
{
public:
  static TypeId GetTypeId (void);

  RegularDataWifiMac ();
  virtual ~RegularDataWifiMac ();
...
private:
  RegularDataWifiMac (const RegularDataWifiMac &);
  RegularDataWifiMac & operator= (const RegularDataWifiMac &);
