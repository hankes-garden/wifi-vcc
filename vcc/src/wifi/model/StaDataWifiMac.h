...
#ifndef STADATAWIFIMAC_H_
#define STADATAWIFIMAC_H_

#include "ns3/regular-data-wifi-mac.h"
...
class StaDataWifiMac: public ns3::RegularDataWifiMac
{
public:
  static TypeId GetTypeId (void);

  StaDataWifiMac ();
  virtual ~StaDataWifiMac ();
