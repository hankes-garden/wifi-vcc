 ...
 */
#ifndef REGULAR_CTRL_WIFI_MAC_H
#define REGULAR_CTRL_WIFI_MAC_H
 ...
 *
 */
class RegularCtrlWifiMac : public WifiMac
{
public:
  static TypeId GetTypeId (void);

  RegularCtrlWifiMac ();
  virtual ~RegularCtrlWifiMac ();
...
private:
  RegularCtrlWifiMac (const RegularCtrlWifiMac &);
  RegularCtrlWifiMac & operator= (const RegularCtrlWifiMac &);
