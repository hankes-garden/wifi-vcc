...
#ifndef LIN_UDP_SERVER_H
#define LIN_UDP_SERVER_H
 ...
 */
class LinUdpServer : public Application
{
public:
  static TypeId GetTypeId (void);
  LinUdpServer ();
  virtual ~LinUdpServer ();
  /**
  ...
  void SetBoundNetDevice(Ptr<NetDevice> netDevice);
...
private:
  ...
  Ptr<NetDevice> m_boundedNetDevice;
};
